	...
	<div id="page-wrapper">
					...
					<section>
							<div id="ff" hidden="" >
								<div class="row uniform">
									<div class="12u$">
										<label for="demo-priority-low">Convencionistas bancaseguros y medios de pago</label> <select id="c1"
											name="c1">
									...
									<div class="6u 12u$(xsmall)" hidden="">
									 	<label for="demo-priority-low">Invitado</label>
									<select id="c2"
											name="c2">
									...
									<div class="6u 12u$(xsmall)">
										<label for="demo-priority-low">Fecha de nacimiento (dd/mm/aaaa)</label> <input
								...
								<div class="row uniform">
									...
									<div class="6u 12u$(xsmall)">
										<label for="demo-priority-low">Emisi&oacute;n de pasaporte (dd/mm/aaaa)</label>
										<input type="date" name="c8" id="c8"
											placeholder="Fecha de emision" />
									</div>
									<div class="6u 12u$(xsmall)">
										<label for="demo-priority-low">Expiraci&oacute;n de pasaporte (dd/mm/aaaa)
        ...
        ?>
								...
								<div class="row uniform">
									...
									<div class="6u 12u$(xsmall)">
										<label for="demo-priority-low">Emisi&oacute;n VISA (dd/mm/aaaa)</label> <input
											type="date" name="c13" id="c13"
											placeholder="Fecha de emision" disabled="disabled" />
									</div>
									<div class="6u 12u$(xsmall)">
										<label for="demo-priority-low">Expiraci&oacute;n VISA (dd/mm/aaaa)</label>
